...
/// Loads IremboPay inline checkout in a [WebView]. Pops with `true` on client success, `false` otherwise.
/// Authoritative status still comes from the backend webhook; poll after pop.
